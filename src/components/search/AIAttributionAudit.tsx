      ...
      <div className="p-6 md:p-8 relative z-10">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-xl font-black text-gray-900 tracking-tight font-[Poppins]">AI <span className="text-indigo-600">Attribution</span> Audit</h3>
              <p className="text-[10px] font-bold text-gray-400 mt-0.5 uppercase tracking-widest leading-none">Source Contribution Analysis</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="bg-neutral-50 rounded-2xl p-5 md:p-6 border border-neutral-100 relative">
              ...
              <p className="text-lg md:text-xl font-medium text-gray-800 leading-relaxed font-[Inter]">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-[2rem] p-6 border border-gray-100 shadow-sm relative overflow-hidden">
              <h4 className="flex items-center gap-2 text-[11px] font-black text-gray-900 uppercase tracking-widest mb-4">
              ...
              <div className="space-y-4">
                {data.attributions
                  ...
                  .map((attr, i) => (
                    <div
                      key={i}
                      className={`group/attr p-2.5 rounded-xl transition-all border ${
                        activeSourcePosition === attr.sourcePosition ? 'bg-indigo-50 border-indigo-100' : 'bg-white border-transparent hover:bg-neutral-50'
                      }`}
                    >
                      <div className="flex items-center justify-between mb-1.5">
                        <span className="text-[9px] font-black text-gray-400 uppercase tracking-tighter">Source #{attr.sourcePosition}</span>
                        <span className="text-xs font-black text-gray-900">{attr.contributionScore}%</span>
                      </div>
